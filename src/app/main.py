...
# 🔹 Ensure Ollama uses tunnel URL if provided
if "TUNNEL_URL" in st.secrets:
    os.environ["OLLAMA_HOST"] = st.secrets["TUNNEL_URL"]
elif "TUNNEL_URL" in os.environ:
    os.environ["OLLAMA_HOST"] = os.environ["TUNNEL_URL"]
